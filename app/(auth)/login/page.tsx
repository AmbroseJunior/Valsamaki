        ...
        <div className="bg-[var(--color-card)] rounded-[var(--radius-2xl)] border border-[var(--color-border)] shadow-[var(--shadow-lg)] overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 border border-[var(--color-border)] rounded-[var(--radius-full)] hover:bg-[var(--color-muted)] transition-colors text-sm font-semibold"
            >
