...
// OWASP A01 — client-side safe redirect (mirrors server-side check)
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-1">
            ...
            <div className="text-left">
              ...
              <p className="text-[#FCDA06] text-xs font-semibold tracking-widest uppercase">Admin Access</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full px-4 py-3 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#FCDA06] transition-shadow"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#FCDA06] transition-shadow"
                  style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', color: 'white' }}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-full font-bold text-sm transition-opacity hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2"
