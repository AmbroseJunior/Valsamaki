...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
      <h1 className="font-display text-2xl font-bold text-[var(--color-foreground)]">{t('title')}</h1>

      {/* Account actions */}
      <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-[var(--radius-2xl)] overflow-hidden">
        <div className="px-5 py-4 border-b border-[var(--color-border)]">
          <h2 className="font-semibold text-sm text-[var(--color-foreground)]">{t('account')}</h2>
        </div>
      ...
      <div className="bg-[var(--color-card)] border border-[var(--color-destructive)]/30 rounded-[var(--radius-2xl)] overflow-hidden">
        <div className="px-5 py-4 border-b border-[var(--color-destructive)]/20 bg-[var(--color-destructive)]/5">
          <h2 className="font-semibold text-sm text-[var(--color-destructive)]">{t('dangerZone')}</h2>
        </div>
        <div className="px-5 py-5 space-y-3">
          <div>
            <p className="text-sm font-semibold text-[var(--color-foreground)]">{t('deleteAccount')}</p>
