      ...
      <div className="relative w-full max-w-sm space-y-8 text-center">
        ...
        <div>
          ...
          <p className="text-white/50 text-sm leading-relaxed">
            ...
            and the real Mediterranean diet. Leave your email and we&apos;ll reach out
        ...
        {done ? (
          <div className="space-y-4 py-2">
            <div className="text-6xl">{status === 'success' ? '🎉' : '✅'}</div>
            <p className="text-white font-bold text-xl">
              {status === 'success' ? "You're on the list!" : "Already registered!"}
            </p>
            <p className="text-white/50 text-sm leading-relaxed">
              We&apos;ll send you an early-access invite when Valsamaki goes live.
